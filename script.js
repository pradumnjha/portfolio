...
// Observe skill categories, project cards, and cert cards
...
function setupMobileMenu() {
    // This can be implemented if you add a hamburger menu button
...
// Detect dark mode preference and apply if needed
function applyDarkMode() {
    if (window.matchMedia && window.matchMedia('(prefers-color-scheme: dark)').matches) {
        // User prefers dark mode - adjust if needed
